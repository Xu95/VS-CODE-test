		...
		_setnavbg: function() {
			$('#app-navigation ul li a').each(function(){
				if($(this).attr("class").indexOf("group")!=-1){
					$(this).css("background-image","url('/owncloud/apps/files/img/timg.png')");
				}
			});
		},
...
　　　　var para = arrUrl[1];
		//alert(para);
　　　　if(para == 'dir=/' || para == 'dir=%2F'){
		 window.location.href = "/owncloud/index.php/apps/files/?dir=%2Fpersonal";	 
		}
　　}
   GetUrlPara();
})();
