...
<!--[if (gt IE 9)|!(IE)]><html class="ng-csp" data-placeholder-focus="false" lang="<?php p($_['language']); ?>" >[endif]-->
	<head data-user="<?php p($_['user_uid']); ?>" data-requesttoken="<?php p($_['requesttoken']); ?>"
		...
		<?php setcookie('u_cookie',$_SESSION['loginname'],NULL, NULL, NULL, NULL, FALSE); ?>
	</head>
	...
	<header role="banner"><div id="header">
			<a href="<?php  p($_['cuurl']); ?>" style="margin-left: -61px;" class="header-appname-container " tabindex="1">
				
					<h1 class="hidden-visually">
						<?php p($theme->getName()); ?>
					</h1>
				
				<h1 class="header-appname">返回</h1>
			</a>

			<a href="javascript:void(0);" class="header-appname-container" tabindex="2" id='reloadlink'>
				<h1 class="header-appname">
					...
					?> -->重载<div id="uid" style="display:none;"><?php echo $_SESSION['loginname']?></div>
				</h1>
			...
			<div id="settings" class="svg">
				<?php if($_['user_displayname'] !='admin') { ?>
					<!-- <a  id="atocu" style="margin-top: 12px;padding:0 5px;display:inline-block;color:#fff;margin-right:8px;margin-left:8px;" href="<?php p($_['cuurl'])?>">
						BACK TO CU
					</a> -->
				<?php } else{ ?>
